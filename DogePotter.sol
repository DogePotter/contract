...
contract DOGEPOTTER is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x71Cb6101E0FDe7b84A3000f76EDFE902B47baB88); // Marketing Address
    ...
    uint256 private _tTotal = 3000000 * 10**9 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Doge Potter Token";
    string private _symbol = "DOGEPOTTER";
    ...
    constructor () {
        ...
        // uniswap Router Testnet v2 - Not existing
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _taxFee = 0;
        _liquidityFee = 0;
        _maxTxAmount = 3000000 * 10**9 * 10**9;
    }
